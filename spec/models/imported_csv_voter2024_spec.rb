...
RSpec.describe ImportedCsvVoter2024, type: :model do
  describe "Creation" do
    ...
    it "builds from csv" do
      imported_voter = ImportedCsvVoter2024.build_from(@rows.first)
    ...
    it "builds from csv 2" do
      imported_voter = ImportedCsvVoter2024.build_from(@rows.second)
    ...
    it "sets sane default values when source value is blank" do
      imported_voter = ImportedCsvVoter2024.build_from(@rows.third)
